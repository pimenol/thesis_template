...
The digital content revolution has transformed journalism into a high-velocity industry where platforms must simultaneously manage exponential content growth and maintain rigorous quality standards. \cite{seznam2025} (\reffig{fig:main_page}), serving over 5 million daily users, now employs an automated system to classify the quality of all submitted articles. To ensure the reliability of this system, a randomly selected subset of articles is reviewed manually by human editors. This approach addresses the key challenges posed by the scale and speed of modern content production:
\begin{itemize}
\item \textbf{Scalability limitations:} With article submissions increasing by 50\% annually, manual evaluation of all content is no longer feasible
\item \textbf{Consistency issues:} Human judgments can vary significantly, making automation essential for uniform quality standards
\item \textbf{Quality degradation risks:} Unchecked content may harm platform credibility through misinformation or poor structure
\end{itemize}
...
\item Significant reduction in human workload
\item 24/7 operational capacity without fatigue
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.5\textwidth]{./fig/photos/Seznam_main_page.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.4\textwidth]{./fig/photos/Current_Editorial_Workflow.png}
...
\begin{itemize}
  ...
  \item \ac{Class 2}: Sufficiently developed content with clear structure and supported by multiple references.
