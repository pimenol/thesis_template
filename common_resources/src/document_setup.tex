...
\usepackage[backend=bibtex,defernumbers=true,style=numeric,sorting=ydnt,sorting=ydnt]{biblatex}

% \DeclareCiteCommand{\cite}
%   {\usebibmacro{prenote}}
%   {%
%     \printnames{labelname}~\printdateextra~\hyperlink{cite.\thefield{entrykey}}{[\printfield{labelnumber}]}
%   }
%   {\multicitedelim}
...
\DeclareCiteCommand{\cite}
  ...
  {%
    \printtext[bibhyperref]{%
      \printnames{labelname}~\printdateextra~[\printfield{labelnumber}]%
    }%
  }
  {\multicitedelim}
  {\usebibmacro{postnote}}
