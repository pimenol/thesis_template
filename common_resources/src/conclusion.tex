...
The hybrid DeBERTaV3+CatBoost classifier consistently outperformed all other approaches tested in this study. On the held-out test set, it achieved the highest weighted F1 score ($\approx$0.78), exceeding the performance of individual models and approaching the estimated human inter-annotator agreement of $\approx$80\%. 
