...
\\[0.5em]of articles}
\newcommand{\Keywords}{\ac{NLP}, article classification, text classification, machine learning, Czech language, journalistic quality}
\newcommand{\KlicovaSlova}{zpracování přirozeného jazyka, klasifikace článků, strojové učení, čeština, kvalita článku}
\newcommand{\Year}{2025}
\newcommand{\Month}{May}
